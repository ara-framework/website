...
![GatsbyJS Diagram](/img/0_lbuc243qwiUZl1ax.png)
...
![new:nova output](/img/1_p1xWHmakQ147zbISb-zZyg.png)
...
![nova server running output](/img/1_xUz4UslQbZ40MDwgu7g-kg.png)
...
![run:lambda ouput](/img/1_iZpfY93ddLDP0jRhKXRz9A.png)
...
![run:lambda --asset output](/img/1_fu7nixAMWx9SsT6Md3hBww.png)
...
![Gatsby project home page](/img/1_akLqBO85oIM8mAKJoWxK0Q.png)
...
![Nova Bridge diagram](/img/1_1LXUoTxvmX7GNsmLlFv-eA.png)
...
![gatsby page with ara](/img/1_LCUNxnpPoyIouqCiQ4shNQ.png)
...
![gatsby with ara](/img/1_QGnGgOp8gq9nX_7BsMlviA.png)
...
![gatsby build output](/img/1_Iqzjpl9WxiZEXZ2SJ0Cf1g.png)
...
![server-side rendered html](/img/1_0FmwXJnJcdaDLSxY1ztVng.png)
...
![NOva Static Diagram](/img/1_6Xfi3GoFGuRcSwSEZaEB_A.png)
...
![nova-static output](/img/1_wodj2jlGvz6LqIJ5HiCVtw.png)
...
![rendered html by nova-static](/img/1_kT_X2-7b33qdukc1s92GCQ.png)
...
![page without js](/img/1_TW1_emP6y4OOQ6X60Ax2fA.png)
...
![page 2 in browser](/img/1_gz3YwZHsOxSPFthKTBKFrg.png)
